...
def get_ground_truth(url, name):
    try:
        ...
        container = re.findall(r'samza.container.id=.', html)
        print(container)
        container_name = "container" + container[0].split("=")[1]
        file = open("../data/analysis/"+container_name+".html", "w+")
        file.write(html)
        file.close()
...
if __name__ == "__main__":
    ...
    app_url = "http://localhost:8088/cluster/appattempt/appattempt_1559544527540_0021_000001"
